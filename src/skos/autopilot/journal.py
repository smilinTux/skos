"""Shim: re-exports skharness.autocode.journal (Wave 2, Phase B of the autocode extraction).

skos.autopilot.journal now delegates to the shared engine in skharness.autocode;
...
to skharness.autocode.journal instead.
"""
from skharness.autocode.journal import *  # noqa: F401,F403
