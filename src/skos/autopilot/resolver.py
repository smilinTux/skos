"""Shim: re-exports skharness.autocode.resolver (Wave 2, Phase B of the autocode extraction).

skos.autopilot.resolver now delegates to the shared engine in skharness.autocode;
...
to skharness.autocode.resolver instead.
"""
from skharness.autocode.resolver import *  # noqa: F401,F403
