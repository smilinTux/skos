"""Shim: re-exports skharness.autocode.adapters.claude_code (Wave 2, Phase B of the autocode extraction).
...
"""
from skharness.autocode.adapters.claude_code import *  # noqa: F401,F403
