"""Shim: re-exports skharness.autocode.executor (Wave 2, Phase B of the autocode extraction).

skos.autopilot.executor now delegates to the shared engine in skharness.autocode;
...
to skharness.autocode.executor instead.
"""
from skharness.autocode.executor import *  # noqa: F401,F403
